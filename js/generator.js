...
(function(){
	...
	//获取所有可走的点
	Gen.prototype.generatorMoves = function(){
		var mvs = []; // 存储所有可走的点
			...
			switch(pcSrc - pcSelfSide){
				...
				case game.board.PIECE_BISHOP: //象
					for(var i=0;i<4;i++){
						...
						if(!(game.board.inBoard(sqDst) && P.SAME_HALF(sqSrc,sqDst) && game.board.squares[sqPin] == 0)){
							continue;
						}
						var pcDst = game.board.squares[sqDst];
						//终点位置为空，或者为对方棋子，合法
